...
for(i = 0; i < num; i++)
{
    ...
    DrawPiece(PieceIndex, tempX, tempY, 0, 0.75, 0.75, 1, 100)
    
    tempX += XO
    tempY += YO
    
    DrawPiece(PieceIndex, tempX, tempY, 3, 0.75, 0.75, 1, 0)
    ...
    DrawPiece(PieceIndex, tempX, tempY, 1, 0.75, 0.75, 1, 0)
}

DrawPiece(PieceIndex, 920, 256, 0, 0.75, 0.75, 1, 0)
...
for(i = 0; i < num; i++)
{
    ...
    DrawPiece(PieceIndex, tempX, tempY, 1, 0.75, 0.75, 1, 100)
    
    tempX += XO
    tempY += YO
    
    DrawPiece(PieceIndex, tempX, tempY, 0, 0.75, 0.75, 1, 0)
    ...
    DrawPiece(PieceIndex, tempX, tempY, 2, 0.75, 0.75, 1, 0)
}

DrawPiece(PieceIndex, 896, 512, 1, 0.75, 0.75, 1, 0)
...
for(i = 0; i < num; i++)
{
    ...
    DrawPiece(PieceIndex, tempX, tempY, 2, 0.75, 0.75, 1, 100)
...
DrawPiece(PieceIndex, 920, 768, 2, 0.75, 0.75, 1, 0)
...
for(i = 0; i < num; i++)
{
    ...
    DrawPiece(PieceIndex, tempX, tempY, 3, 0.75, 0.75, 1, 100)
...
DrawPiece(PieceIndex, 904, 1024, 3, 0.75, 0.75, 1, 0)
